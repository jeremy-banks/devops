locals {
  vpc_central_egress_cidrsubnets_primary = (
    var.azs_number_used == 4 ? cidrsubnets(var.vpc_cidr_infrastructure.central_egress_primary, 3, 3, 3, 3, 12, 12, 12, 12) :
    var.azs_number_used == 3 ? cidrsubnets(var.vpc_cidr_infrastructure.central_egress_primary, 2, 2, 2, 12, 12, 12) :
    var.azs_number_used == 2 ? cidrsubnets(var.vpc_cidr_infrastructure.central_egress_primary, 2, 2, 12, 12) :
    null
  )

  vpc_central_egress_public_subnets_primary = (
    var.azs_number_used == 4 ? [local.vpc_central_egress_cidrsubnets_primary[0], local.vpc_central_egress_cidrsubnets_primary[1], local.vpc_central_egress_cidrsubnets_primary[2], local.vpc_central_egress_cidrsubnets_primary[3]] :
    var.azs_number_used == 3 ? [local.vpc_central_egress_cidrsubnets_primary[0], local.vpc_central_egress_cidrsubnets_primary[1], local.vpc_central_egress_cidrsubnets_primary[2]] :
    var.azs_number_used == 2 ? [local.vpc_central_egress_cidrsubnets_primary[0], local.vpc_central_egress_cidrsubnets_primary[1]] :
    null
  )

  vpc_central_egress_intra_subnets_primary = (
    var.azs_number_used == 4 ? [local.vpc_central_egress_cidrsubnets_primary[4], local.vpc_central_egress_cidrsubnets_primary[5], local.vpc_central_egress_cidrsubnets_primary[6], local.vpc_central_egress_cidrsubnets_primary[7]] :
    var.azs_number_used == 3 ? [local.vpc_central_egress_cidrsubnets_primary[3], local.vpc_central_egress_cidrsubnets_primary[4], local.vpc_central_egress_cidrsubnets_primary[5]] :
    var.azs_number_used == 2 ? [local.vpc_central_egress_cidrsubnets_primary[2], local.vpc_central_egress_cidrsubnets_primary[3]] :
    null
  )
