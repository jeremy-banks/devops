...
resource "aws_ec2_transit_gateway_route" "post_central_inspection_workload_spoke_a_primary_to_primary" {
  provider = aws.networking_prd
...
resource "aws_ec2_transit_gateway_route" "post_central_inspection_workload_spoke_a_primary_to_failover" {
  provider = aws.networking_prd
