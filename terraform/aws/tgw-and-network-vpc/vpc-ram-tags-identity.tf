...
resource "aws_ec2_tag" "subnets_pub0_identity" {
  provider    = aws.identity
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pub1_identity" {
  provider    = aws.identity
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pub2_identity" {
  provider    = aws.identity
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pvt0_identity" {
  provider    = aws.identity
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pvt1_identity" {
  provider    = aws.identity
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pvt2_identity" {
  provider    = aws.identity
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pub0_identity_failover" {
  provider    = aws.identity_failover
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pub1_identity_failover" {
  provider    = aws.identity_failover
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pub2_identity_failover" {
  provider    = aws.identity_failover
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pvt0_identity_failover" {
  provider    = aws.identity_failover
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pvt1_identity_failover" {
  provider    = aws.identity_failover
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
...
resource "aws_ec2_tag" "subnets_pvt2_identity_failover" {
  provider    = aws.identity_failover
  depends_on  = [
    aws_ram_principal_association.network_primary_infrastructure_ou,
    aws_ram_resource_association.vpc_primary_subnets,
