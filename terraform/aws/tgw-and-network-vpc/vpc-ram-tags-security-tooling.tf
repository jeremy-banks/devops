...
# resource "aws_ec2_tag" "subnets_pub0_security_tooling" {
#   provider    = aws.security_tooling
#   depends_on  = [
#     aws_ram_principal_association.network_primary_security_ou,
#     aws_ram_resource_association.vpc_primary_subnets,
...
# resource "aws_ec2_tag" "subnets_pub1_security_tooling" {
#   provider    = aws.security_tooling
#   depends_on  = [
#     aws_ram_principal_association.network_primary_security_ou,
#     aws_ram_resource_association.vpc_primary_subnets,
...
# resource "aws_ec2_tag" "subnets_pub2_security_tooling" {
#   provider    = aws.security_tooling
#   depends_on  = [
#     aws_ram_principal_association.network_primary_security_ou,
#     aws_ram_resource_association.vpc_primary_subnets,
...
# resource "aws_ec2_tag" "subnets_pvt0_security_tooling" {
#   provider    = aws.security_tooling
#   depends_on  = [
#     aws_ram_principal_association.network_primary_security_ou,
#     aws_ram_resource_association.vpc_primary_subnets,
...
# resource "aws_ec2_tag" "subnets_pvt1_security_tooling" {
#   provider    = aws.security_tooling
#   depends_on  = [
#     aws_ram_principal_association.network_primary_security_ou,
#     aws_ram_resource_association.vpc_primary_subnets,
...
# resource "aws_ec2_tag" "subnets_pvt2_security_tooling" {
#   provider    = aws.security_tooling
#   depends_on  = [
#     aws_ram_principal_association.network_primary_security_ou,
#     aws_ram_resource_association.vpc_primary_subnets,
...
#   ]
#   count       = var.create_failover_region ? length(merge(local.vpc_tags_failover, local.default_tags, { "Name" = "${local.vpc_name_failover}" })) : 0
...
# resource "aws_ec2_tag" "subnets_pub0_security_tooling_failover" {
#   provider    = aws.security_tooling_failover
#   depends_on  = [
#     aws_ram_principal_association.network_failover_security_ou,
#     aws_ram_resource_association.vpc_failover_subnets,
#   ]
#   count       = var.create_failover_region ? length(merge(local.subnet_pub_tags_failover, local.default_tags, { "Name" = "${local.vpc_subnet_pub_name_failover}0}" })) : 0
...
# resource "aws_ec2_tag" "subnets_pub1_security_tooling_failover" {
#   provider    = aws.security_tooling_failover
#   depends_on  = [
#     aws_ram_principal_association.network_failover_security_ou,
#     aws_ram_resource_association.vpc_failover_subnets,
#   ]
#   count       = var.create_failover_region ? length(merge(local.subnet_pub_tags_failover, local.default_tags, { "Name" = "${local.vpc_subnet_pub_name_failover}1}" })) : 0
...
# resource "aws_ec2_tag" "subnets_pub2_security_tooling_failover" {
#   provider    = aws.security_tooling_failover
#   depends_on  = [
#     aws_ram_principal_association.network_failover_security_ou,
#     aws_ram_resource_association.vpc_failover_subnets,
#   ]
#   count       = var.create_failover_region && var.vpc_five9s_enabled ? length(merge(local.subnet_pub_tags_failover, local.default_tags, { "Name" = "${local.vpc_subnet_pub_name_failover}2" })) : 0
...
# resource "aws_ec2_tag" "subnets_pvt0_security_tooling_failover" {
#   provider    = aws.security_tooling_failover
#   depends_on  = [
#     aws_ram_principal_association.network_failover_security_ou,
#     aws_ram_resource_association.vpc_failover_subnets,
#   ]
#   count       = var.create_failover_region ? length(merge(local.subnet_pvt_tags_failover, local.default_tags, { "Name" = "${local.vpc_subnet_pvt_name_failover}0" })) : 0
...
# resource "aws_ec2_tag" "subnets_pvt1_security_tooling_failover" {
#   provider    = aws.security_tooling_failover
#   depends_on  = [
#     aws_ram_principal_association.network_failover_security_ou,
#     aws_ram_resource_association.vpc_failover_subnets,
#   ]
#   count       = var.create_failover_region ? length(merge(local.subnet_pvt_tags_failover, local.default_tags, { "Name" = "${local.vpc_subnet_pvt_name_failover}1" })) : 0
...
# resource "aws_ec2_tag" "subnets_pvt2_security_tooling_failover" {
#   provider    = aws.security_tooling_failover
#   depends_on  = [
#     aws_ram_principal_association.network_failover_security_ou,
#     aws_ram_resource_association.vpc_failover_subnets,
#   ]
#   count       = var.create_failover_region && var.vpc_five9s_enabled ? length(merge(local.subnet_pvt_tags_failover, local.default_tags, { "Name" = "${local.vpc_subnet_pvt_name_failover}2" })) : 0
