...
resource "aws_ec2_tag" "subnets_pub0_security_tooling_failover" {
  ...
  count       = var.vpc_failover_enabled ? length(merge(local.subnet_pub_tags_primary, local.default_tags, { "Name" = "${local.vpc_subnet_pub_name_primary}0}" })) : 0
...
resource "aws_ec2_tag" "subnets_pub1_security_tooling_failover" {
  ...
  count       = var.vpc_failover_enabled ? length(merge(local.subnet_pub_tags_primary, local.default_tags, { "Name" = "${local.vpc_subnet_pub_name_primary}1}" })) : 0
...
resource "aws_ec2_tag" "subnets_pub2_security_tooling_failover" {
  ...
  count       = var.vpc_failover_enabled && var.vpc_five9s_enabled ? length(merge(local.subnet_pub_tags_primary, local.default_tags, { "Name" = "${local.vpc_subnet_pub_name_primary}2" })) : 0
...
resource "aws_ec2_tag" "subnets_pvt0_security_tooling_failover" {
  ...
  count       = var.vpc_failover_enabled ? length(merge(local.subnet_pvt_tags_primary, local.default_tags, { "Name" = "${local.vpc_subnet_pvt_name_primary}0" })) : 0
...
resource "aws_ec2_tag" "subnets_pvt1_security_tooling_failover" {
  ...
  count       = var.vpc_failover_enabled ? length(merge(local.subnet_pvt_tags_primary, local.default_tags, { "Name" = "${local.vpc_subnet_pvt_name_primary}1" })) : 0
...
resource "aws_ec2_tag" "subnets_pvt2_security_tooling_failover" {
  ...
  count       = var.vpc_failover_enabled && var.vpc_five9s_enabled ? length(merge(local.subnet_pvt_tags_primary, local.default_tags, { "Name" = "${local.vpc_subnet_pvt_name_primary}2" })) : 0
