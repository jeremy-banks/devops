...
module "vpc_primary_main_sg" {
  ...
  computed_ingress_with_source_security_group_id = [
    {
      rule  = "all-all"
      source_security_group_id = module.vpc_primary_alb_sg.security_group_id
      description = "allow ingress from ${module.vpc_primary_alb_sg.security_group_name}"
    },
  ]
  ...
  computed_egress_with_source_security_group_id = [
    {
      rule  = "all-all"
      source_security_group_id = module.vpc_primary_alb_sg.security_group_id
      description = "allow egress to ${module.vpc_primary_alb_sg.security_group_name}"
    },
  ]
}

module "vpc_primary_alb_sg" {
  source  = "terraform-aws-modules/security-group/aws"
  version = "5.1.0"
  ...
  computed_ingress_with_source_security_group_id = [
    {
      rule  = "all-all"
      source_security_group_id = module.vpc_primary_main_sg.security_group_id
      description = "allow ingress from ${module.vpc_primary_main_sg.security_group_name}"
    },
  ]
  ...
  computed_egress_with_source_security_group_id = [
    {
      rule                     = "all-all"
      source_security_group_id = module.vpc_primary_main_sg.security_group_id
      description = "allow egress to ${module.vpc_primary_main_sg.security_group_name}"
    },
  ]
}
