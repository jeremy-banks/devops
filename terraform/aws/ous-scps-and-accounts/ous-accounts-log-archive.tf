...
resource "aws_organizations_account" "log_archive_prd" {
  ...
  email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.email_suffix.log_archive}-prd@${var.org_owner_email_domain_tld}"
...
resource "aws_organizations_account" "log_archive_stg" {
  ...
  email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.email_suffix.log_archive}-stg@${var.org_owner_email_domain_tld}"
