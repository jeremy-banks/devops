...
resource "aws_organizations_account" "workload_sdlc_prd" {
  ...
  email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.email_suffix.workload_sdlc}-prd@${var.org_owner_email_domain_tld}"
...
resource "aws_organizations_account" "workload_sdlc_stg" {
  ...
  email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.email_suffix.workload_sdlc}-stg@${var.org_owner_email_domain_tld}"
...
resource "aws_organizations_account" "workload_sdlc_tst" {
  ...
  email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.email_suffix.workload_sdlc}-tst@${var.org_owner_email_domain_tld}"
...
resource "aws_organizations_account" "workload_sdlc_dev" {
  ...
  email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.email_suffix.workload_sdlc}-dev@${var.org_owner_email_domain_tld}"
