...
resource "aws_organizations_account" "shared_services_prd" {
  ...
  email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.account_name.shared_services}-prd@${var.org_owner_email_domain_tld}"
...
#   email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.account_name.shared_services}-stg@${var.org_owner_email_domain_tld}"
...
#   name  = "${var.account_name.shared_services}-tst"
#   email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.account_name.shared_services}-tst@${var.org_owner_email_domain_tld}"
...
#   name  = "${var.account_name.shared_services}-dev"
#   email = "${var.org_owner_email_prefix}+${var.org_owner_email_plus_address}-${var.account_name.shared_services}-dev@${var.org_owner_email_domain_tld}"
