...
locals {
  this_account_id   = var.account_id.workload_wsu_prd
  vpc_cidr_primary  = var.vpc_cidr.workload_wsu_prd_primary
  vpc_cidr_failover = var.vpc_cidr.workload_wsu_prd_failover
}