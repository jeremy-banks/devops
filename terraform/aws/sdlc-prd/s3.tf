...
module "s3_primary" {
  ...
  bucket = "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-storage-blob-${local.unique_id}"
...
module "s3_failover" {
  ...
  bucket = "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-storage-blob-${local.unique_id}"
