module "vpc_primary" {
  ...
  name = "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-vpc"
  public_subnet_names   =  [
    "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-vpc-pub-0",
    "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-vpc-pub-1",
    "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-vpc-pub-2",
  ]
  private_subnet_names  = [
    "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-vpc-pvt-0",
    "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-vpc-pvt-1",
    "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd-vpc-pvt-2",
  ]
  ...
  vpc_tags = merge({"Name" = "${local.resource_name_stub}-${var.region.primary_short}-sdlc-prd"}, local.vpc_tags_primary)
...
module "vpc_failover" {
  ...
  name = "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-vpc"
  public_subnet_names   =  [
    "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-vpc-pub-0",
    "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-vpc-pub-1",
    "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-vpc-pub-2",
  ]
  private_subnet_names  = [
    "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-vpc-pvt-0",
    "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-vpc-pvt-1",
    "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd-vpc-pvt-2",
  ]
  ...
  vpc_tags = merge({"Name" = "${local.resource_name_stub}-${var.region.failover_short}-sdlc-prd"}, local.vpc_tags_primary)
